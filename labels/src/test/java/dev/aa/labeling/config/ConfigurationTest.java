...
class ConfigurationTest {
    ...
    void testConfiguration() {
        Configuration config = new Configuration(
            ...
            new LabelerConfiguration(true, 15, 200, 0.3, 0.2, java.util.List.of(), java.nio.file.Path.of("data"), java.nio.file.Path.of("output/labels"), "labels.json", null, null, 0, null),
            java.util.List.of()
        );
