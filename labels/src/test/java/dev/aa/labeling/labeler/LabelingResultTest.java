...
class LabelingResultTest {
    ...
    void testConstructor() {
        List<LabeledSentence> sentences = List.of(
            new LabeledSentence("http://example.com/f1", "http://example.com/1", "ru", "text1", List.of(new LabelEntry("label1", "label1", null, 0, 6, true)), List.of()),
            new LabeledSentence("http://example.com/f1", "http://example.com/2", "ru", "text2", List.of(new LabelEntry("label2", "label2", null, 0, 6, true)), List.of())
        );
    ...
    void testGetSentences() {
        LabeledSentence sentence = new LabeledSentence("http://example.com/f1", "http://example.com", "en", "test", List.of(new LabelEntry("a", "a", null, 0, 1, true)), List.of());
    ...
    void testGetTotalSentences() {
        List<LabeledSentence> sentences = List.of(
            new LabeledSentence("http://example.com/f1", "http://example.com/1", "ru", "text1", List.of(new LabelEntry("l1", "l1", null, 0, 2, true)), List.of()),
            new LabeledSentence("http://example.com/f1", "http://example.com/2", "ru", "text2", List.of(new LabelEntry("l2", "l2", null, 0, 2, true)), List.of()),
            new LabeledSentence("http://example.com/f1", "http://example.com/3", "ru", "text3", List.of(new LabelEntry("l3", "l3", null, 0, 2, true)), List.of())
        );
